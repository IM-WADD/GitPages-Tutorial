...
This tutorial assumes you already have a repo in your own GitHub account that you would like to publish as a website. **Make sure you make the repository public. Git Pages does not work with private repositories unless you have GitHub Pro**
   - You can get GitHub pro by signing up for the GitHub education package using your York email acount.
   - 
1. Open the repo in your browser and go to the settings page:
...
3. Under 'Branch' select the main branch and click Save.
...
4. Your repository is now setup for Git Pages. If you already have code in your repo, you are done. If you haven't already added some code, there won't be anything to show on the website yet! Follow the steps below to create an html page for your website.
5. Go back to the 'Code' page of your repository and create a new file.
...
7. Add this code to your index.html file. You can do this directly in the broswer by editing the file you have created.
```
<!doctype html>
<html lang="en">
  <head>
...
9. If you navigate back to the 'Pages' section in settings you should now be able to see a messsage saying your site is live. This usually takes the form: https://yourusername.github.io/repositoryName
...
10. Click the 'Visit Site' button and you should see your website with the message "Hello WADD World!" It may take a few seconds (or even minutes) for Git Pages to update and show you the live version of your code. 
